# activeadmin_batched_export RFCs
...
Writing, length, and claim rules live in RFC 0001. Isolation is off. RFCs MAY name repository paths. Prefer another RFC for design cross-references.
...
Standards Track: RFC 0002 keyset export cursor (Proposed). RFC 0003 export freeze, row cap, and NULL-safe keys (Proposed).

A public API, file, or protocol change needs a new Standards Track RFC.
